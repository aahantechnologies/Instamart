         ...
         <div class="row extra_margin">
            <div class="col-md-12">
               <form method='post' action=''>
                  <div class="col-md-4">                     
                     <div class="ollfix zoom-cnt " style="float:left; margin: 0;">
                     <span class='zoom ollfix' id='ex1'>
					 <input type='hidden' name='code' value="<?php echo $row['code']; ?>" />
                         <img src='<?php echo $row['image']; ?>' width='auto' height='350' width="70" alt='Daisy on the Ohoopee'/>    
                     </span>
                  </div>
                  </div>
                  <div class="ollfix col-md-8 product_inner_1">
                   ...
                   <option value="<?php echo $row['price1']; ?>"><?php echo $row['price1']; ?> &nbsp;<?php echo $row['quantity1']; ?> </option>
                    ...
                    <option value="<?php echo $row['price6']; ?>"><?php echo $row['price6']; ?> &nbsp;<?php echo $row['quantity6']; ?> </option> 
                     ...
                     <div class="highlight ollfix">
                        <div class="service ollfix">                           
                           <ul>
                              <li>                                 
                              </li>
                              <li class="">                              
     ...
     <div class="row extramargin productcat">
        <div class="col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1" style="text-align:center;">    
            <h1>SIMILAR PRODUCTS</h1>                   
                  <?php                
                  $result = mysqli_query($con,"SELECT * FROM product_detail where type='$type' LIMIT 0,5");
