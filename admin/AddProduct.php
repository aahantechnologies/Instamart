                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-xl-12">
								...
								<div class="form-group">
									<label class="control-label col-md-2 col-sm-2 col-xs-12">Product Type</label>
                                    <div class="col-md-8 col-sm-4 col-xs-12">
                                       <select class="form-control" name="type"> 
										 <?php 

$sql = mysqli_query($con, "SELECT name FROM product_type");
...
$sql = mysqli_query($con, "SELECT name FROM brand");
...
?>		
            <div class="form-group">
				<label class="control-label col-md-2 col-sm-2 col-xs-12">Quantity</label>
                                    ...
                                    <div class="col-md-8 col-sm-4 col-xs-12">
                                        <input class="form-control" type="text" name="price1" placeholder="eg. 100 Rs">
									</div>									
								</div>
            ...
            <div class="form-group">
				<label class="control-label col-md-2 col-sm-2 col-xs-12">Quantity</label>
                               ...
                               <div class="form-group">
									<label class="control-label col-md-2 col-sm-2 col-xs-12">Price </label>
                                    <div class="col-md-8 col-sm-4 col-xs-12">
                                        <input class="form-control" type="text" name="price2" placeholder="eg. 100 Rs">
									</div>								
								</div> 
                                 <?php
// Include the database configuration file
...
?>		
            <div class="form-group">
				<label class="control-label col-md-2 col-sm-2 col-xs-12">Quantity</label>
									...
									<label class="control-label col-md-2 col-sm-2 col-xs-12">Price</label>
                                    <div class="col-md-8 col-sm-4 col-xs-12">
                                        <input class="form-control" type="text" name="price3" placeholder="eg. 100 Rs">
									</div>									
								</div> 
                                                 <?php
// Include the database configuration file
...
?>		
            <div class="form-group">
				<label class="control-label col-md-2 col-sm-2 col-xs-12">Quantity</label>
									...
									<label class="control-label col-md-2 col-sm-2 col-xs-12">Price</label>
                                    <div class="col-md-8 col-sm-4 col-xs-12">
                                        <input class="form-control" type="text" name="price4" placeholder="eg. 100 Rs">
									</div>									
								</div> 
                                                  <?php
// Include the database configuration file
...
?>		
            <div class="form-group">
				<label class="control-label col-md-2 col-sm-2 col-xs-12">Quantity</label>
									...
									<label class="control-label col-md-2 col-sm-2 col-xs-12">Price </label>
                                    <div class="col-md-8 col-sm-4 col-xs-12">
                                        <input class="form-control" type="text" name="price5" placeholder="eg. 100 Rs">
									</div>									
						<?php
// Include the database configuration file
require 'dbConfig.php';
...
?>		
            <div class="form-group">
				...
				<label class="control-label col-md-2 col-sm-2 col-xs-12">price </label>
                                    <div class="col-md-8 col-sm-4 col-xs-12">
                                        <input class="form-control" type="text" name="price6" placeholder="eg. 100 Rs">
									</div>									
								</div> 
                                                 <?php
// Include the database configuration file
...
if(isset($_REQUEST['s']))
{
    ...
    $query="insert into product_detail values(NULL,'$product_name','$type','$brand','$feature','$benefit','$quantity1','$price1','$quantity2','$price2','$quantity3','$price3','$quantity4','$price4','$quantity5','$price5','$quantity6','$price6','$category','$code','$destination','$status','$liked','$newarrival')";     
