                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Brand</h2>
	                                <div>
			                            <ul class="breadcrumb">
			                                <li class="breadcrumb-item"><a href="db-default.html"><i class="ti ti-home"></i></a></li>
			                                <li class="breadcrumb-item active">Brand's</li>
			                            </ul>
	                                </div>
	                            </div>
                                <div class="widget-body">
                                        <div class="form-group">
                                            <a href="AddBrand.php">  <button type="button" class="btn btn-primary mr-1 mb-2">Add Brand</button></a>
...
?>
                                                    <tr>
                                                        ...
                                                        <td class="td-actions">
 <?php echo" <a title='update record' href='EditBrand.php?regid=$row1[0]'><i class='la la-edit edit'></i> </a>";
                        ?>
                                                          <?php echo" 
                      <a title='Delete record' href='Brand.php?regid=$row1[0]'>  <i class='la la-close delete'></i>
</a>";                  
                        ?>
                                                        </td>
                                                    </tr>
...
$regid=$_REQUEST['regid'];
  ...
  $query="delete from brand where regid=$regid";
