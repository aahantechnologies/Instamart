                            ...
                            <div class="page-header">
                                ...
                                <div class="widget-body">
                                        <div class="form-group">
                                            <a href="AddCategory.php">  <button type="button" class="btn btn-primary mr-1 mb-2">Add Category</button></a>
...
?>
                                                    <tr>
                                                        ...
                                                        <td class="td-actions">
 <?php echo" <a title='update record' href='EditCategory.php?id=$row1[0]'><i class='la la-edit edit'></i> </a>";
                        ?>
                                                          <?php echo" 
                      <a title='Delete record' href='Category.php?id=$row1[0]'>  <i class='la la-close delete'></i>
</a>";                  
                        ?>
                                                        </td>
                                                    </tr>
