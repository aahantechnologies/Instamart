                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="widget has-shadow">
                                    ...
                                    <div class="col-md-8 col-sm-4 col-xs-12">
                                        <input class="form-control" value="<?php echo $row1['name'];?>" type="text" name="name">
									</div>
								...
								<center><input type="submit" class="btn btn-success pull-right-container" name="s"  value="Update Category"></center>
								</div> </div> <br/>
...
if(isset($_REQUEST['s']))
{
 ...
 echo "<script> alert('Record added')</script>";
        echo "<script>window.location='EditSubCategory.php'</script>";
