...
$query="select * from grocerynav where regid=$regid";
                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Sub Menu Grocery</h2>
	                                <div>
			                            <ul class="breadcrumb">
...
{
    extract($_REQUEST);
    $query="update grocerynav set submenu1='$submenu1',submenu2='$submenu2',submenu3='$submenu3',submenu4='$submenu4',submenu5='$submenu5',submenu6='$submenu6',submenu7='$submenu7',submenu8='$submenu8',submenu9='$submenu9',submenu10='$submenu10' where regid=$regid";
