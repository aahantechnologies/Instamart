...
$query="select * from vegetablenav where regid=$regid";
...
{
    extract($_REQUEST);
    $query="update vegetablenav set submenu1='$submenu1',submenu2='$submenu2',submenu3='$submenu3',submenu4='$submenu4',submenu5='$submenu5',submenu6='$submenu6',submenu7='$submenu7',submenu8='$submenu8',submenu9='$submenu9',submenu10='$submenu10' where regid=$regid";
