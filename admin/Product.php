...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <div id="preloader">
            <div class="canvas">
                 <h1 class="loader-logo">InstaMart</h1>
                                            ...
                                            <table class="table mb-0">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Category</th>
                                                        <th>image</th>
                                                        <th><span style="width:100px;">Featured Product</span></th>
                                                        <th>Grocery</th>
														<th>New Arrivals</th>
                                                        <th>Actions</th>
                                                    </tr>
...
$query1="select * from product_detail";
...
{
?>
<a href="grocery.php?liked=<?php echo $row1['regid'];?>" 
 class="act1" onclick="return confirm('Activate <?php echo $regid?>');"> Deactivate </a>
<?php
}
if(($liked)=='1')
{
?>
<a href="grocery.php?liked=<?php echo $row1['regid'];?>" 
 class="deact1" onclick="return confirm('De-activate <?php echo $regid?>');"> Activate</a>
<?php
}
?>     
 </td>           
...
{
?>
<a href="NewArrivals.php?newarrival=<?php echo $row1['regid'];?>" 
 class="act2" onclick="return confirm('Activate <?php echo $regid?>');"> Deactivate </a>
<?php
}
if(($newarrival)=='1')
{
?>
<a href="NewArrivals.php?newarrival=<?php echo $row1['regid'];?>" 
 class="deact2" onclick="return confirm('De-activate <?php echo $regid?>');"> Activate</a>
<?php
}
?>     
 </td>        
                                                        <td class="td-actions">
                                                            <?php echo" <a title='update record' href='UpdateProduct.php?regid=$row1[0]'><i class='la la-edit edit'></i> </a>";
                        ?>
                                                          <?php echo" 
                      <a title='Delete record' href='Product.php?regid=$row1[0]'>  <i class='la la-close delete'></i>
</a>";                  
                        ?>
                                                        </td>
                                                    </tr>
...
$regid=$_REQUEST['regid'];
  $query="delete from product_detail where regid=$regid";
