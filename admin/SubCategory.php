                            ...
                            <div class="page-header">
                                ...
                                <div class="widget-body">
                                        <div class="form-group">
                                            <a href="AddSubCategory.php">  <button type="button" class="btn btn-primary mr-1 mb-2">Add Sub Category</button></a>
...
?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row1['parent_id'];?></td> 
                                                        <td><?php echo $row1['name'];?></td> 
                                                        <td class="td-actions">
 <?php echo" <a title='update record' href='EditSubCategory.php?id=$row1[0]'><i class='la la-edit edit'></i> </a>";
                        ?>
                                                          <?php echo" 
                      <a title='Delete record' href='SubCategory.php?id=$row1[0]'>  <i class='la la-close delete'></i>
</a>";                  
                        ?>
                                                        </td>
                                                    </tr>
