	                            ...
	                            <div class="d-flex align-items-center">
	                                ...
	                                <div>
			                            <ul class="breadcrumb">
			                                ...
			                                <li class="breadcrumb-item active">Sub Menu Fruits</li>
			                            </ul>
	                                </div>
	                            </div>
...
<td><?php echo $row1['submenu7'];?></td>
                                                        ...
                                                        <td class="td-actions">
                                                            <?php echo" <a title='update record' href='EditSubFruits.php?regid=$row1[0]'><i class='la la-edit edit'></i> </a>";
                        ?>
