                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Sub Menu Fruits</h2>
	                                <div>
			                            <ul class="breadcrumb">
			                                <li class="breadcrumb-item"><a href=""><i class="ti ti-home"></i></a></li>
			                                <li class="breadcrumb-item active">Sub Menu Grocery</li>
			                            </ul>
	                                </div>
	                            </div>
...
<td><?php echo $row1['regid'];?></td>

<td><?php echo $row1['submenu1'];?></td>
<td><?php echo $row1['submenu2'];?></td>
<td><?php echo $row1['submenu3'];?></td>
<td><?php echo $row1['submenu4'];?></td>
<td><?php echo $row1['submenu5'];?></td>
<td><?php echo $row1['submenu6'];?></td>
<td><?php echo $row1['submenu7'];?></td>
                                                        
                                                        
                                                        <td class="td-actions">
                                                            <?php echo" <a title='update record' href='EditSubGrocery.php?regid=$row1[0]'><i class='la la-edit edit'></i> </a>";
                        ?>
