                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Sub Menu</h2>
	                                <div>
			                            <ul class="breadcrumb">
...
$query1="select * from vegetablenav";
...
<td><?php echo $row1['submenu7'];?></td>
                                                        ...
                                                        <td class="td-actions">
                                                            <?php echo" <a title='update record' href='EditSubVegetable.php?regid=$row1[0]'><i class='la la-edit edit'></i> </a>";
                        ?>
