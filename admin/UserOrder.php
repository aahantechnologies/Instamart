...
$query1 ="SELECT DISTINCT order_product.product_name,order_details.phone_number,order_product.code,order_details.first_name,order_product.quantity,order_details.last_name,order_product.price,order_details.house_no,order_details.home_address,order_details.area,order_details.landmark,order_details.street_detail,order_details.pincode,order_details.city,order_details.dateandtime FROM order_product,order_details where order_product.first_name=order_details.first_name";
...
?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row1['house_no'];?></td>
                                                        <td><?php echo $row1['home_address'];?></td>
                                                        <td><?php echo $row1['area'];?></td>
                                                        <td><?php echo $row1['landmark'];?></td>
														<td><?php echo $row1['street_detail'];?></td>                                        
														...
														<td><?php echo $row1['dateandtime'];?></td>                                          
                                                    </tr>                                                  
<?php
}
?>
