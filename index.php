   ...
   <body>
      ...
      <div class="row extramargin mywhychoose">       
        <div class="col-sm-12" style="background:#e6fdef">
          <div class="col-sm-3" style="padding-top: 20px;">WHY CHOOSE ORGANIC AT InstaMart</div>
          <div class="col-sm-9">
...
while($row = mysqli_fetch_assoc($result)){
	?>
            ...
            <div class="col-md-2 col-sm-3 col-xs-6" id="pdct_img">
                <a href="OneProduct.php?regid=<?php echo $row['regid'];?> && type=<?php echo $row['type'];?>"> <img  src="<?php echo $row['image']; ?>" height="156" width="156" alt="demo">
